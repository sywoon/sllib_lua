...
local base_char,keywords=128,{"and","break","do","else","elseif","end","false","for","function","if","in","local","nil","not","or","repeat","return","then","true","until","while","string","table","insert","tostring","require","console","numbertostring","format","print","self","ipairs","preload","package","os","set","type","logs","list","\"table\"","pairs","execute","gsub","time","totaltime","\"number\"","attributes","concat","sub","debug","reportsByTitle","math","resetColor","setColor","isSupportLineColor","tableAddress","defaultColor","writeFile","any2str","calltime","__showInnerRef","\"/\"","logFunc","callcount","clock","_showLogs","splitpath","elems","getFuncReport","setmetatable","basename","mkpredir","member","mkdir","linedefined","\"string\"","\"\"","dirname","loadstring","modf","'\"'","millitime","match","short_src","io","unpack","rawset","tolist","\"\\n\"","\" localhost > NUL\"","invert","remove","profilingHandler","tonumber","readFile","\"Unknown object!\"","subClass","tracingHandler","exist","new","sethook","isdir","__keyCanBeNum","getinfo","trace","date","level","\"\\\\\"","intersection","getFuncTitle","'\\t'","splitpathex","_G","writeInFile","values","rawget","currentdir","tostringex","\"color %02X\"","close","extension","month","traceback","startTime","_VERSION","clearLog","\"  \"",}; function prettify(code) return code:gsub("["..string.char(base_char).."-"..string.char(base_char+#keywords).."]", 
...
å â e(e,...)e=e èÔå t={...}å n={}à t,e ã †(t)É
ó.ò(n,_U2A(ª(e)))Ü
å e=ó.∞(n,e)ë e
Ü
â printu(...)å e=e(Ô,...)û(e)Ü
â printuw(...)å e=e(Ô,...)printw(e)Ü
â printue(...)å e=e(Ô,...)printe(e)Ü
...
ë n
Ü
â ’.readJsonFile(e,n)å e=’.ﬂ(e)ä ç==e è e==Õí
ë ç
Ü
ä n í
e=n(e)Ü
...
Ü
â £.˘(e)ë ñ.”(e,"%.%w*$")Ü
â £. (t)t=e(t)å t=£.(t)å e=Õà o=1,#t É
...
Ü
Ü
å e={Ω=á,Á=ì,}o(ó,e)å â r(r)ä é Ω í
ë{}Ü
...
â §.Ì(n,t)å e=§.‰()à n ã §.ƒ(n)É
ä §.…(t,n)í
§.ò(e,n)Ü
Ü
ë e
Ü
â §.ÿ(n)å e={}à n ã §.ƒ(n)É
ó.ò(e,n)Ü
ë e
Ü
â §.û(e)å e=§.ÿ(e)ó.û(e)Ü
å â l(n,t)å e=§.‰()à n ã §.ƒ(n)É
§.ò(e,n)Ü
à n ã §.ƒ(t)É
§.ò(e,n)Ü
ë e
...
â ¨.¡()ë £.¡()Ü
â ¨.“()ö"socket.core"ë ¥.–(socket.gettime()*1e3)Ü
â ¨.sleep(e)e=e è 0
£.™("ping -n "..ﬁ(e+1)..⁄)Ü
...
ë n
Ü
å e=£.Í("*t")å e=ñ.ù("%s_%s_%s.log",e.year,e.˙,e.day)n=e
ë e
Ü
å â c(n)ä é a í
ë
...
Ü
Ü
Ü)¢.°['sllib.profiler']=(â(...)å e={}â e:setLogFunc(e)ü.ø=e
Ü
â e:setLevel(e)ü.Î=e
Ü
â e:start(e)e=e è"profile"ü.ø=û
ä e=="trace"í
≤.Â(bind(ü.‚,ü),'c')Ñ
ü.≥={}ü.¸=£.¡()ü.Î=3
≤.Â(bind(ü.›,ü),'cr')Ü
Ü
â e:stop(e)e=e è"profile"≤.Â()ä e=="trace"í
ë
Ü
ü.stopTime=£.¡()å n=ü.stopTime-ü.¸
ä n<.001 í
ü.ø("total time less 0.001s")ë
Ü
å e=ó.Û(ü.≥)ó.sort(e,â(e,n)ë e.≠>n.≠
Ü)à t,e ã †(e)É
å n=(e.≠/n)*100
ä n<1 í
Ç
Ü
å e=ñ.ù("time:%6.3f, percent:%.2f%%, count:%d, %s",e.≠,n,e.¿,e.title)ü.ø(e)Ü
Ü
â e:‚()å e=≤.Ë(ü.Î,'nS')å e=ñ.ù("file:%s line:%d function:%s()",e.‘,e.À,e.name èÕ)ü.ø(e)Ü
â e:Ó(e)å t=e.name è'anonymous'å n=e.‘ è'C_FUNC'å e=e.À è 0
ë ñ.ù("file:%s line:%s function:%s",n,e,t)Ü
â e:≈(e)å n=ü:Ó(e)å e=ü.≥[n]ä é e í
e={title=n,¿=0,≠=0,}ü.≥[n]=e
Ü
ë e
Ü
â e:›(n)å o=â(e)å e=ü:≈(e)e.º=£.¡()e.¿=e.¿+1
Ü
å t=â(e)å n=£.¡()å e=ü:≈(e)ä e.º Å e.º>0 í
e.≠=e.≠+(n-e.º)e.º=0
Ü
Ü
å e=≤.Ë(ü.Î,'nS')ä e í
