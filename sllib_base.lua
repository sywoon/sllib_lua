...
local base_char,keywords=128,{"and","break","do","else","elseif","end","false","for","function","if","in","local","nil","not","or","repeat","return","then","true","until","while","string","table","insert","require","console","tostring","numbertostring","format","self","ipairs","package","preload","os","print","type","set","logs","list","\"table\"","pairs","execute","totaltime","\"number\"","sub","concat","attributes","debug","time","gsub","reportsByTitle","resetColor","math","setColor","isSupportLineColor","defaultColor","tableAddress","writeFile","any2str","\"/\"","calltime","__showInnerRef","getFuncReport","callcount","_showLogs","splitpath","logFunc","clock","elems","setmetatable","mkpredir","basename","linedefined","member","mkdir","\"string\"","modf","dirname","loadstring","'\"'","io","short_src","match","\" localhost > NUL\"","rawset","\"\\n\"","remove","profilingHandler","tolist","unpack","\"\"","readFile","\"Unknown object!\"","subClass","tonumber","tracingHandler","new","date","getinfo","isdir","exist","sethook","trace","__keyCanBeNum","level","'\\t'","getFuncTitle","intersection","\"\\\\\"","rawget","invert","splitpathex","_G","writeInFile","currentdir","\"color %02X\"","month","extension","traceback","startTime","close","clearLog","stopTime","_VERSION","\"ping -n \"","\"  \"","setLevel",}; function prettify(code) return code:gsub("["..string.char(base_char).."-"..string.char(base_char+#keywords).."]", 
...
ä µ.Õ(e)~=e í
ë õ(e)Ü
å n=µ.fmod(e,10^13)å e=µ.Õ(e/10^13)å e=ñ.ù("%s%013s",õ(e),õ(n))ë e
Ü
â ª(e,n)ä §(e)==Ãí
ä n Å e~=÷í
ë–..e..–Ñ
...
å â n(e,...)e=e èÍå t={...}å n={}à t,e ã ü(t)É
ó.ò(n,_U2A(ª(e)))Ü
å e=ó.Æ(n,e)ë e
Ü
â printu(...)å e=n(Í,...)£(e)Ü
â printuw(...)å e=n(Í,...)printw(e)Ü
â printue(...)å e=n(Í,...)printe(e)Ü
...
å r=¢.Œ(o)¢.À(r)å r=ô"cjson"è ô"json"å e=r.encode(e)ä n í
e=ñ.≤(e,"\\/",º)e=ñ.≤(e,"\\\\",º)Ü
ä t í
e=t(e)Ü
—.∫(o,e)ë ì
...
å e=n(e)()ë e
Ü
â —.writeLuaFile(t,o,n)å e=¢.Œ(t)¢.À(e)ä ç==ó.õ í
ë á
Ü
å e=ó.õ(o)ä ç==e í
ë á
...
â ¢.sleep(e)e=e è 1
¢.™(˝..ﬂ(e+1)..‘)Ü
å â e(e,n)e=ñ.≤(e,Ì,º)e=ñ.≤(e,"//",º)ä ñ.≠(e,-1,-1)==ºí
ä é n í
e=ñ.≠(e,1,-2)Ü
Ñ
ä n í
...
Ü
â ¢.ˆ(e)ë ñ.”(e,"%.%w*$")Ü
â ¢.À(t)t=e(t)å t=¢.(t)å e=€à o=1,#t É
...
¢.™(e)ë ì
Ü
â ¢.copyfile(o,n,e)¢.«(n)o=ñ.≤(o,º,Ì)n=ñ.≤(n,º,Ì)å t
ä e í
...
ä e í e(t)Ü
ë ¢.™(t)Ü
â ¢.movefile(t,n,o)t=e(t)n=e(n)ä é ¢.Â(t)í
ä o í
...
i(o,e)ë l,r
Ü
â ¢.dirext(o,t,e)å n=ó.Ô(e)ë ¢.dir(o,t,â(e,t)ä t í
ë ì
Ü
å e=¢.ˆ(e)ä n[e]í
ë ì
...
Ü
Ü
å e={æ=á,Ë=ì,}t(ó,e)å â r(r)ä é æ í
ë{}Ü
...
e=_tostring(n)Ñ
e=c(n)Ü
ë ñ.≤(e,"^table: ",€)è€Ü,["tostring"]=c,["tostringex"]=l,["print"]=â(e)ä §(e)~=®í
Ò.£(e)Ñ
Ò.£(ó.õ(e))Ü
...
ë e,t
Ü
Ü)†.°['sllib.math_ext']=(â(...)â µ.cutf(e,n)å t,e=µ.Õ(e)å e=e*µ.pow(10,n)e=µ.Õ(e)e=e/µ.pow(10,n)ë t+e
Ü
...
å n=˛å t=e+t
ï e<t É
å t=∞.„(e,"nS")l=t.what=="main"å o={}ó.ò(o,ñ.ù(n.."file:%s line:%d function:%s()\n",t.“,t.…,t.name è€))n=n..˛à n=1,i É
...
ë n
Ü
â ß.merge(...)å e=ß.Æ(...)e=ó.Ô(e)ë ó.keys(e)Ü
...
â ±.ƒ()ë ¢.ƒ()Ü
â ±.millitime()ô"socket.core"ë µ.Õ(socket.gettime()*1e3)Ü
â ±.sleep(e)e=e è 0
¢.™(˝..ﬂ(e+1)..‘)Ü
â ±.getstr(e,n)e=e è'%c'n=n è ¢.±()ë ¢.‚(e,n)Ü
â ±.getendofday(e)e=e è ¢.±()å e=¢.‚('*t',e)å e=¢.‚('*t',¢.±({year=e["year"],ı=e["month"],day=e["day"],hour=23,min=59,sec=59}))å e=¢.±(e)ë e
Ü
â ±.tohour(e)å n=µ.Õ(e/3600)å t=µ.Õ(µ.fmod(e,3600)/60)å e=µ.fmod(e,60)ë{hour=n,min=t,sec=e}Ü
...
ë t
Ü
å e=¢.‚("*t")å e=ñ.ù("%s_%s_%s.log",e.year,e.ı,e.day)t=e
ë e
Ü
å â c(e)ä é i í
ë
...
å e=¢.‚("*t")å o=¢.ƒ()å n=t
ä l í
n=ñ.ù("[%s-%s-%s %02s:%02s:%02s %s]%s",e.year,e.ı,e.day,e.hour,e.min,e.sec,o,t)Ü
£(n)c(n..'\n')Ü
â ¶.Ú(e)i=e
Ü
â ¶.showLogTime(e)l=e
...
Ü
â ¶.f(e,...)o(ñ.ù(e,...))Ü
â ¶.Á(e,...)e=e è"nil"å e=ñ.ù(e,...)å e=∞.˜(e,2)o(e)Ü
ë ¶
...
Ü
â e:‡()å e=∞.„(û.È,'nS')å e=ñ.ù("file:%s line:%d function:%s()",e.“,e.…,e.name è€)û.√(e)Ü
â e:Î(e)å t=e.name è'anonymous'å n=e.“ è'C_FUNC'å e=e.… è 0
ë ñ.ù("file:%s line:%s function:%s",n,e,t)Ü
â e:ø(e)å n=û:Î(e)å e=û.≥[n]ä é e í
e={title=n,¿=0,´=0,}û.≥[n]=e
Ü
ë e
Ü
â e:ÿ(n)å t=â(e)å e=û:ø(e)e.Ω=¢.ƒ()e.¿=e.¿+1
Ü
å o=â(e)å n=¢.ƒ()å e=û:ø(e)ä e.Ω Å e.Ω>0 í
e.´=e.´+(n-e.Ω)e.Ω=0
Ü
Ü
å e=∞.„(û.È,'nS')ä e í
...
Ü
ë e
Ü)’(Ò,"SLLIB_VERSION","1.1.2")ô"sllib.console"ô"sllib.global"ô"sllib.lang"ô"sllib.io_ext"ô"sllib.os_ext"ô"sllib.table_ext"ô"sllib.string_ext"ô"sllib.list_ext"ô"sllib.set"ô"sllib.math_ext"ô"sllib.debug_ext"ô"sllib.time"ô"sllib.logs"ô"sllib.class"enum=ó.Ô
log=log è ¶.i
logw=logw è ¶.w
loge=loge è ¶.e
logf=logf è ¶.f
...
⁄=⁄ è ó.⁄
œ=œ è load
’(Ò,"bind",â(e,...)å n={...}assert(e,"bind params error")ë â(...)å n=ß.Æ(n,{...})ë e(⁄(n))Ü
Ü)â ª(e)ä §(e)==Ãí
ë–..e..–Ö §(e)==®í
ë ó.õ(e)Ö §(e)==¨í
ë ú(e)Ñ
